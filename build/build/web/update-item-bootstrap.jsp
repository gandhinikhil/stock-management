...
<body>
	...
	<nav class="navbar navbar-light" style="background-color:#ffc107;">
		<div class="container">
			<h2><i class="fas fa-pen-square"></i> Update Item</h2>
		</div>
	</nav>
		...
		<div>
			<form action="ItemController" method="get">
				...
				<div class="form-group">
					...
					<input type="text" id="inputName" name="itemName" placeholder="Item Name" class="form-control" value="${ITEM.itemName}" required="required">	
				</div>
				
				<div class="form-group">
					<label for="inputUnit">Unit: </label>
					<input type="text" id="inputUnit" name="unit" placeholder="Eg 250 ml, 50 mg, 100 pcs" class="form-control" value="${ITEM.unit}" required="required">
				</div>
				
				<div class="form-group">
					<label for="inputBI">Beginning Inventory: </label>
					<input type="number" id="inputBI" name="beginningInventory" placeholder="Initial quantity" class="form-control" value="${ITEM.beginningInventory}" required="required">
				</div>
				
				<div class="form-group">
					<label for="inputQuantity">Quantity On Hand: </label>
					<input type="number" id="inputQuantity" name="quantityOnHand" placeholder="Current Total Stock" class="form-control" value="${ITEM.quantityOnHand}" required="required">
				</div>
				
				<div class="form-group">
					<label for="inputPrice">Price Per Unit: </label>
					<input type="number" id="inputPrice" name="pricePerUnit" placeholder="Price in rupees" class="form-control" value="${ITEM.pricePerUnit}" required="required">
				</div>
				
				<div class="form-group">
					<label for="inputDOM">Date Of Manufacture: </label>
					<input type="date" id="inputDOM" name="dateOfManufacture" placeholder="Date Of Maunufacture" class="form-control" value="${ITEM.dateOfManufacture}" required="required">
				</div>
				
				<div class="form-group">
					<label for="inputDOE">Date Of Expiry: </label>
					<input type="date" id="inputDOE" name="dateOfExpiry" placeholder="Date Of Expiry" class="form-control" value="${ITEM.dateOfExpiry}" required="required">
				</div>
